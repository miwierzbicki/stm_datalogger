...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(GPIOA, ADC1_IN0_INT_Pin|ADC1_IN1_INT_Pin|ADC1_IN2_INT_Pin|ADC1_IN3_INT_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB9     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(SCL_ADS_GPIO_Port, SCL_ADS_Pin);

    HAL_GPIO_DeInit(SDA_ADS_GPIO_Port, SDA_ADS_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, SCK_SD_Pin|MISO_SD_Pin|MOSI_SD_Pin);
